...
class PrimaryModel:
    ...
    def from_pretrained(self, model_name, load_model=False):
        if load_model and model_name is None:
            ...
            if self.global_unet is None and self.p_ckpt is None:
                ...
                self.p_ckpt = get_model_path(model_name=model_name, model_paths=p_ckpt_path)
        else:
            ...
            if model_name is not None:
                sd = torch.load(self.p_ckpt, map_location="cpu")
